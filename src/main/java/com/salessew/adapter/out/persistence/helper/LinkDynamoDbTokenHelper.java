...
import static com.salessew.adapter.out.persistence.DynamoDbAttributeConstants.LINK_ID;
import static com.salessew.adapter.out.persistence.DynamoDbAttributeConstants.LINK_USER_ID;
...
public class LinkDynamoDbTokenHelper {
    ...
    public Map<String, AttributeValue> decodeStartToken(String token) {
        try {
            ...
            throw new RuntimeException("Failed to decode start token", e);
        }
    }
